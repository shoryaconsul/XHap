...
def train_caecseq(zonename, ploidy, expt):
    ...
    print('All MEC scores: ', mec_record)
    print('Best MEC score: %.3f' %(np.amin(mec_record)))
...
if __name__ == "__main__":
    ...
    train_caecseq(args.zonename, args.ploidy, args.expt)